package com.pickmylunch.api.global.exception;

import com.pickmylunch.api.global.exception.code.ExceptionCode;
        ...
        public static List<ConstraintViolationError> of(Set<ConstraintViolation<?>> constraintViolations) {
            return constraintViolations.stream()
                    .map(constraintViolation -> {
                        String invalidValue = constraintViolation.getInvalidValue() == null ? "" : constraintViolation.getInvalidValue().toString();
                        if (invalidValue.startsWith("{bcrypt}")) {
                            invalidValue = "********";
                        }
